...
train_dir = os.getcwd() + "/trainedFromCheckpointFullModelTrainSetSize/"+str(numTrainExamples)+"/forceFlow_forces/"+modelType+"/"+run
...
if __name__ == '__main__':
	...
	restorableVariables = [v for v in tf.get_collection("restorableVariables") if "/nuTildaConv" not in v.name or ("popMean" not in v.name and "popVariance" not in v.name)]
