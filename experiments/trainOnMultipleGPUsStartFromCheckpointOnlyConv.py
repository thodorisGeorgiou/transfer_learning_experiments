...
train_dir = os.getcwd() + "/trainedFromCheckpointFullModelTrainSetSize/"+str(numTrainExamples)+"_2/"+preTrainSupervision+"_forces/"+modelType+"/"+run
# train_dir = os.getcwd() + "/trainedFromCheckpointOnlyConvLayers/flow_forces/"+modelType+"/"+run
...
if __name__ == '__main__':
	...
	trainData, testData, numTrainExamples, numTestExamples, testIterator = preprocessing.inputFlows(batch_size, numTrainExamples=numTrainExamples)
